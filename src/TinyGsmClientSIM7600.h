...
class TinyGsmSim7600 : public TinyGsmModem<TinyGsmSim7600>,
  ...
  public:
    String getNetworkModes() {
      ...
      sendAT(GF("+CNMP=?"));
      if (waitResponse(GF(AT_NL "+CNMP:")) != 1) {
        return "";
      }
    ...
    bool getNetworkSystemMode(bool& n, int16_t& stat) {
      ...
      sendAT(GF("+CNSMOD?"));
      if (waitResponse(GF(AT_NL "+CNSMOD:")) != 1) {
        return false;
      }
  ...
  protected:
    bool gprsConnectImpl(const char* apn, const char* user = nullptr,
      ...
      sendAT(GF("+NETOPEN"));
      if (waitResponse(75000L, GF(AT_NL "+NETOPEN: 0")) != 1) {
        return false;
      }
    ...
    bool gprsDisconnectImpl() {
      ...
      // service
      sendAT(GF("+NETCLOSE"));
      if (waitResponse(60000L, GF(AT_NL "+NETCLOSE: 0")) != 1) {
        return false;
      }
    ...
    bool isGprsConnectedImpl() {
      ...
      if (waitResponse(GF(AT_NL "+NETOPEN: 1")) != 1) {
        return false;
      }
      waitResponse();
  ...
  protected:
    ...
    String getGPSrawImpl() {
      sendAT(GF("+CGNSSINFO"));
      if (waitResponse(GF(AT_NL "+CGNSSINFO:")) != 1) {
        return "";
      }
      String res = stream.readStringUntil('\n');
      waitResponse();
    ...
    uint8_t getGNSSModeImpl() {
      sendAT(GF("+CGNSSMODE?"));
      if (waitResponse(GF(AT_NL "+CGNSSMODE:")) != 1) {
        return 0;
      }
  ...
  protected:
    ...
    int16_t getBattVoltageImpl() {
      sendAT(GF("+CBC"));
      if (waitResponse(GF(AT_NL "+CBC:")) != 1) {
        return 0;
      }
  ...
  protected:
    ...
    uint16_t getTemperatureImpl() {
      sendAT(GF("+CPMUTEMP"));
      if (waitResponse(GF(AT_NL "+CPMUTEMP:")) != 1) {
        return 0;
      }
  ...
  protected:
    ...
    int16_t modemSend(const void* buff, size_t len, uint8_t mux) {
      ...
      stream.flush();
      if (waitResponse(GF(AT_NL "+CIPSEND:")) != 1) {
        return 0;
      }
